...
5.  What data types are contained in the variables? (Reminder: <https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables>)
    -   categorical, continuous, discreet - not sure if Year a category or discreet as in number of years.

    -   Discrete if measured in a number of years, minutes, seconds. However it would be continuous if measured to an exact amount of time passed since the start of something. Jan 25, 2017 (Is age a discrete or continuous variable? Why? - Socratic)
