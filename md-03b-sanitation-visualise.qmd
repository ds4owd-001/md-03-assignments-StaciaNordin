...
1.  Use the `count()` function with varname_short and varname_long to identify the definitions of the levels in these two variables.
    -   ***I can't figure out how to use the 'print(n = ...)'***
    -   ***I tried postit community & perplexity and still couldn't figure it out.***
...
2.  What would you want to change?
    ...
    -   ***the results, there is a possible negative trend for sanitation***
    -   ***hard to see the blue and green values***
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3?
    -   ***because we want to focus on the problem?***
    -   ***I'd rather keep it, I think. Maybe it is too crowded?***

## Task 7

1.  Run the code in the code chunk below.
2.  What do you observe when you look at the code and plot?
    -   ***urban sanitation looks better than rural for all data***
